#ifndef NOP_ALGORITHM_TRANSFORM_HPP /* Begin algorithm transform header file */
#define NOP_ALGORITHM_TRANSFORM_HPP 1UL
...
template<
        ...
        >
constexpr OutIterator transform(InIterator  src_begin,
                                InIterator  src_end,
                                OutIterator dst_begin,
                                UnaryOp     unary_op) noexcept(noexcept(*dst_begin++ = unary_op(*src_begin++)))
{
  [[likely]]
...
template<
         ...
         std::invocable<
                       ...
                       > BinaryOp
        >
constexpr OutIterator transform(InIterator1 src1_begin,
                                InIterator1 src1_end,
                                InIterator2 src2_begin,
                                InIterator2 src2_end,
                                OutIterator dst_begin,
                                BinaryOp    binary_op) noexcept(noexcept(*dst_begin++ = binary_op(*src1_begin++, *src2_begin++)))
{
  [[likely]]
...
#endif /* End algorithm transform header file */
