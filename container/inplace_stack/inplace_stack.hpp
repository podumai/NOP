#ifndef NOP_CONTAINER_INPLACE_STACK_HPP /* Begin container inplace_stack header file */
#define NOP_CONTAINER_INPLACE_STACK_HPP 1UL
...
constexpr void swap(nop::container::inplace_stack<T, N>& lhs,
                    nop::container::inplace_stack<T, N>& rhs) noexcept(noexcept(lhs.swap(rhs)))
{
  lhs.swap(rhs);
}
...
#endif /* End container inplace_stack header file */
